...
?>
<!-- Footer Main2 -->
<footer id="footer-main" class="footer-main footer-main2 container-fluid no-left-padding no-right-padding" style="background-image: url(<?php echo esc_url( $footer_image ); ?>">
