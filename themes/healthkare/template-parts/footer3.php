...
?>
<!-- Footer Main3 -->
<footer id="footer-main" class="footer-main footer-main2 footer-main3 container-fluid no-left-padding no-right-padding" style="background-image: url(<?php echo esc_url( $footer_image ); ?>">
	<!-- Container -->
	<div class="container">
		<?php
	...
	<div class="btm-ftr-menu skyblue-footer3 container-fluid no-left-padding no-right-padding">
		<!-- Container -->
		<div class="container">
			<div class="row">
